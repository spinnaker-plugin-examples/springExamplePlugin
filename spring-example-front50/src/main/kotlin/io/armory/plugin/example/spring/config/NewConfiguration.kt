...
class NewConfiguration {
    ...
    @Primary
    @ExposeToApp
    fun awsS3MetadataClient(awsCredentialsProvider: AWSCredentialsProvider,
                            s3Properties: S3MetadataStorageProperties): AmazonS3 {
        return MyAmazonS3() //AmazonS3ClientBuilder.standard().build()
    }

    @Bean
    @Primary
    @ExposeToApp
    fun s3StorageService(awsS3MetadataClient: AmazonS3, s3Properties: S3MetadataStorageProperties): S3StorageService {
        return MyS3StorageService()
    }
...
class MyS3StorageService : S3StorageService(null, null, null, null, null, null, null, null, null) {
